...
func TestParseDatabases(t *testing.T) {
	mockDB1 := linodego.Database{
		...
		Hosts:           linodego.DatabaseHost{Primary: "primary.example.com", Standby: "standby.example.com"},
	...
	mockDB2 := linodego.Database{
		...
		Hosts:           linodego.DatabaseHost{Primary: "primary-pg.example.com", Standby: "standby-pg.example.com"},
