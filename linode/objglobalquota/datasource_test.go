//go:build integration || objglobalquota

package objglobalquota_test
...
import (
	...
	"github.com/linode/terraform-provider-linode/v4/linode/objglobalquota/tmpl"
)

func TestAccDataSourceObjGlobalQuota_basic(t *testing.T) {
	t.Parallel()

	resourceName := "data.linode_object_storage_global_quota.foobar"
