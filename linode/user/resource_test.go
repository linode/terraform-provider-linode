		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.account_access",
						"",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_domains",
						"true",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_databases",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_firewalls",
						"true",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_images",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_linodes",
						"true",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_longview",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_nodebalancers",
						"true",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_placement_groups",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_stackscripts",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_volumes",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.add_vpcs",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.cancel_account",
						"false",
					),
					resource.TestCheckResourceAttr(
						testUserResName,
						"global_grants.0.longview_subscription",
						"false",
					),
