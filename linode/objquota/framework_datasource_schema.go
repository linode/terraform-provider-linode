...
var FrameworkDatasourceSchema = schema.Schema{
	Attributes: ObjectQuotaAttributes,
	//Blocks: map[string]schema.Block{
	//	"quota_usage": schema.SingleNestedBlock{
	//		Description: "Usage data for a specific Object Storage quota on your account.",
	//		Attributes:  quotaUsageAttributes,
	//	},
	//},
}

var ObjectQuotaAttributes = map[string]schema.Attribute{
...
//var quotaUsageAttributes = map[string]schema.Attribute{
//	"quota_limit": schema.Int64Attribute{
//		Description: "The maximum quantity of the `resource_metric` allowed by the quota.",
//		Computed:    true,
//	},
//	"usage": schema.Int64Attribute{
//		Description: "The quantity of the resource currently in use.",
//		Computed:    true,
//	},
//}
