...
import (
	...
	"github.com/linode/terraform-provider-linode/v3/linode/consumerimagesharegroup/tmpl"
)
...
func TestAccDataSourceConsumerImageShareGroup_basic(t *testing.T) {
	t.Parallel()
	...
	resourceName := "data.linode_consumer_image_share_group.foobar"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "label", shareGroupLabel),
					resource.TestCheckResourceAttrSet(resourceName, "description"),
					resource.TestCheckResourceAttrSet(resourceName, "is_suspended"),
				),
			},
		},
	})
