		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "authorized_keys.#", "0"),
					...
					resource.TestCheckResourceAttr(resourceName, "referrals.0.code", ""),
					resource.TestCheckResourceAttr(resourceName, "referrals.0.url", ""),
				),
			},
		},
	})
