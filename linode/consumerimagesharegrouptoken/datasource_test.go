...
import (
	...
	"github.com/linode/terraform-provider-linode/v4/linode/consumerimagesharegrouptoken/tmpl"
)
...
func TestAccDataSourceImageShareGroupToken_basic(t *testing.T) {
	t.Parallel()
	...
	resourceName := "data.linode_consumer_image_share_group_token.foobar"
