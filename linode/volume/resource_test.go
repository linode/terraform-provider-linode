...
func TestSmokeTests_volume(t *testing.T) {
	tests := []struct {
		name string
		test func(*testing.T)
	}{
		{"TestAccResourceVolume_basic_smoke", TestAccResourceVolume_basic_smoke},
	}
