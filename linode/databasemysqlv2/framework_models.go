...
func (m *Model) Flatten(
	...
	m.EngineConfigMySQLConnectTimeout = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLConnectTimeout,
		db.EngineConfig.MySQL.ConnectTimeout,
		preserveKnown,
	)
	...
	m.EngineConfigMySQLNetBufferLength = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLNetBufferLength,
		db.EngineConfig.MySQL.NetBufferLength,
		preserveKnown,
	)
	m.EngineConfigMySQLNetReadTimeout = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLNetReadTimeout,
		db.EngineConfig.MySQL.NetReadTimeout,
		preserveKnown,
	)
	m.EngineConfigMySQLNetWriteTimeout = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLNetWriteTimeout,
		db.EngineConfig.MySQL.NetWriteTimeout,
		preserveKnown,
	)
	m.EngineConfigMySQLSortBufferSize = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLSortBufferSize,
		db.EngineConfig.MySQL.SortBufferSize,
		preserveKnown,
	)
	m.EngineConfigMySQLSQLMode = helper.KeepOrUpdateStringPointer(
		m.EngineConfigMySQLSQLMode,
		db.EngineConfig.MySQL.SQLMode,
		preserveKnown,
	)
	...
	m.EngineConfigMySQLTmpTableSize = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLTmpTableSize,
		db.EngineConfig.MySQL.TmpTableSize,
		preserveKnown,
	)
	m.EngineConfigMySQLWaitTimeout = helper.KeepOrUpdateIntPointer(
		m.EngineConfigMySQLWaitTimeout,
		db.EngineConfig.MySQL.WaitTimeout,
		preserveKnown,
	)
...
func (m *Model) CopyFrom(other *Model, preserveKnown bool) {
	...
	m.EngineConfigBinlogRetentionPeriod = helper.KeepOrUpdateValue(
		m.EngineConfigBinlogRetentionPeriod,
		other.EngineConfigBinlogRetentionPeriod,
		preserveKnown,
	)
	m.EngineConfigMySQLConnectTimeout = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLConnectTimeout,
		other.EngineConfigMySQLConnectTimeout,
		preserveKnown,
	)
	m.EngineConfigMySQLDefaultTimeZone = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLDefaultTimeZone,
		other.EngineConfigMySQLDefaultTimeZone,
		preserveKnown,
	)
	...
	m.EngineConfigMySQLMaxAllowedPacket = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLMaxAllowedPacket,
		other.EngineConfigMySQLMaxAllowedPacket,
		preserveKnown,
	)
	m.EngineConfigMySQLMaxHeapTableSize = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLMaxHeapTableSize,
		other.EngineConfigMySQLMaxHeapTableSize,
		preserveKnown,
	)
	m.EngineConfigMySQLNetBufferLength = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLNetBufferLength,
		other.EngineConfigMySQLNetBufferLength,
		preserveKnown,
	)
	m.EngineConfigMySQLNetReadTimeout = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLNetReadTimeout,
		other.EngineConfigMySQLNetReadTimeout,
		preserveKnown,
	)
	m.EngineConfigMySQLNetWriteTimeout = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLNetWriteTimeout,
		other.EngineConfigMySQLNetWriteTimeout,
		preserveKnown,
	)
	m.EngineConfigMySQLSortBufferSize = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLSortBufferSize,
		other.EngineConfigMySQLSortBufferSize,
		preserveKnown,
	)
	m.EngineConfigMySQLSQLMode = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLSQLMode,
		other.EngineConfigMySQLSQLMode,
		preserveKnown,
	)
	...
	m.EngineConfigMySQLTmpTableSize = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLTmpTableSize,
		other.EngineConfigMySQLTmpTableSize,
		preserveKnown,
	)
	m.EngineConfigMySQLWaitTimeout = helper.KeepOrUpdateValue(
		m.EngineConfigMySQLWaitTimeout,
		other.EngineConfigMySQLWaitTimeout,
		preserveKnown,
	)
}
...
func (m *Model) GetEngineConfig(d diag.Diagnostics) *linodego.MySQLDatabaseEngineConfig {
	...
	if !m.EngineConfigBinlogRetentionPeriod.IsUnknown() {
		engineConfig.BinlogRetentionPeriod = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigBinlogRetentionPeriod.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLConnectTimeout.IsUnknown() {
		engineConfigMySQL.ConnectTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLConnectTimeout.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLInnoDBFlushNeighbors.IsUnknown() {
		engineConfigMySQL.InnoDBFlushNeighbors = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBFlushNeighbors.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLInnoDBFTMinTokenSize.IsUnknown() {
		engineConfigMySQL.InnoDBFTMinTokenSize = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBFTMinTokenSize.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLInnoDBLockWaitTimeout.IsUnknown() {
		engineConfigMySQL.InnoDBLockWaitTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBLockWaitTimeout.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLInnoDBLogBufferSize.IsUnknown() {
		engineConfigMySQL.InnoDBLogBufferSize = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBLogBufferSize.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLInnoDBReadIOThreads.IsUnknown() {
		engineConfigMySQL.InnoDBReadIOThreads = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBReadIOThreads.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLInnoDBWriteIOThreads.IsUnknown() {
		engineConfigMySQL.InnoDBWriteIOThreads = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInnoDBWriteIOThreads.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLInteractiveTimeout.IsUnknown() {
		engineConfigMySQL.InteractiveTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLInteractiveTimeout.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLMaxAllowedPacket.IsUnknown() {
		engineConfigMySQL.MaxAllowedPacket = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLMaxAllowedPacket.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLMaxHeapTableSize.IsUnknown() {
		engineConfigMySQL.MaxHeapTableSize = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLMaxHeapTableSize.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLNetBufferLength.IsUnknown() {
		engineConfigMySQL.NetBufferLength = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLNetBufferLength.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLNetReadTimeout.IsUnknown() {
		engineConfigMySQL.NetReadTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLNetReadTimeout.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLNetWriteTimeout.IsUnknown() {
		engineConfigMySQL.NetWriteTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLNetWriteTimeout.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLSortBufferSize.IsUnknown() {
		engineConfigMySQL.SortBufferSize = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLSortBufferSize.ValueInt64Pointer(),
			&d,
		)
	}
	...
	if !m.EngineConfigMySQLTmpTableSize.IsUnknown() {
		engineConfigMySQL.TmpTableSize = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLTmpTableSize.ValueInt64Pointer(),
			&d,
		)
	}

	if !m.EngineConfigMySQLWaitTimeout.IsUnknown() {
		engineConfigMySQL.WaitTimeout = helper.FrameworkSafeInt64PointerToIntPointer(
			m.EngineConfigMySQLWaitTimeout.ValueInt64Pointer(),
			&d,
		)
	}
