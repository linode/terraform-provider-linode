		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(
						dsAllName,
						"placement_groups.0.placement_group_type",
					),
					...
					resource.TestCheckResourceAttrSet(
						dsAllName,
						"placement_groups.0.placement_group_policy",
					),
					...
					resource.TestCheckResourceAttr(
						dsByLabelName,
						"placement_groups.0.region",
						testRegion,
					),
					resource.TestCheckResourceAttrSet(
						dsByLabelName,
						"placement_groups.0.is_compliant",
					),
					resource.TestCheckResourceAttr(
						dsByLabelName,
						"placement_groups.0.placement_group_policy",
