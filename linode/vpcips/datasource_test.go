		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(
						resourceName_all_ips,
						"vpc_ips.0.subnet_mask",
					),
					...
					resource.TestCheckResourceAttrSet(
						resourceName_all_ips,
						"vpc_ips.0.interface_id",
					),
					resource.TestCheckNoResourceAttr(
						resourceName_all_ips,
						"vpc_ips.0.address_range",
					),
					...
					resource.TestCheckResourceAttrSet(
						resourceName_all_ips,
						"vpc_ips.1.interface_id",
					),
					resource.TestCheckNoResourceAttr(
						resourceName_all_ips,
						"vpc_ips.1.address_range",
					),
