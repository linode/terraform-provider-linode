...
* [`rule_criteria`](#rule_criteria) - (Required, Nested Attribute) The criteria expression for the alert. Referenced directly (e.g. `rule_criteria.rules`).
* [`trigger_conditions`](#trigger_conditions) - (Required, Nested Attribute) The conditions that need to be met to send a notification for the alert. Referenced directly (e.g. `trigger_conditions.criteria_condition`).
...
* [`rules`](#rules) - (Required, Nested Attribute List) A list of rule objects defining the criteria for the alert.
...
* [`dimension_filters`](#dimension_filters) - (Optional, Nested Attribute List) A list of dimension filter objects to filter the metric data.
