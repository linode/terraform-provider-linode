...
* `alerts.0.system_alerts` - A list of system alerts associated with current instance.

* `alerts.0.user_alerts` - A list of user alerts associated with current instance.
